...
export default function FallingObjects({image1, image2, image3}) {
    ...
    function CreateImage1Copies(image) {
      ...
      const singleImageCopies = image1Copies.map( element =>{
        let imageCopy = <img src={image.image} ref={element.ref} id={element.id}/>;
        return (
          imageCopy
        );
      })
  ...
  return (
    <React.Fragment>
      <div className="falling-container" ref={container}>
        {/* <img src={image1} ref={image1Ref} id="firstImage"/>
        <img src={image2} ref={image2Ref} id="secondImage"/>
        <img src={image3} ref={image3Ref} id="thirdImage"/> */}
        <CreateImage1Copies image={image1}/>
        <CreateImage2Copies image={image2}/>
        <CreateImage3Copies image={image3}/>
      </div>
    </React.Fragment>
  );
}
